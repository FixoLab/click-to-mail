 ...
 */
 ...
 /******************** 07.BUTTONS AVAILABILITY  ********************/
 let ctmButtons = document.querySelectorAll(".ctmButtons");
 if (ctmButtons !== undefined) {
   ctmButtons.forEach((item) => {
...
let value = document.querySelector(".withinputmail")?.getAttribute("href");
...
const changeHrefValue = () => {
  ...
  document.querySelector(".withinputmail").href = changeValue;
};
